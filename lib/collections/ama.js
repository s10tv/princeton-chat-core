...
const AmaPostSchema = new SimpleSchema({
  ...
  speakerTagline: { type: String, optional: true },
  ...
  participants: { type: [FollowerSchema], optional: true, defaultValue: [] },
  ...
  type: {type: String, optional: true,
    allowedValues: ['wanted', 'scheduled', 'past'],
    defaultValue: 'wanted'}
})
...
const AmaMessageSchema = new SimpleSchema({
  ...
  numUpvotes: {type: Number, optional: true, defaultValue: 0}
})
